...
cyclonic_eddy = xr.open_dataset(eddy_data_path + "eddy_trajectory_nrt_3.0exp_cyclonic_20180101_20200712.nc").sel(NbSample=0).to_dataframe()
cyclonic_eddy['eddy_polarity'] =  -1
anticyclonic_eddy = xr.open_dataset(eddy_data_path + "eddy_trajectory_nrt_3.0exp_anticyclonic_20180101_20200712.nc").sel(NbSample=0).to_dataframe()
...
def write_metadata():
    vars_meta = xr.open_dataset(eddy_data_path + "eddy_trajectory_nrt_3.0exp_cyclonic_20180101_20200712.nc").sel(NbSample=0).var
    attrs = xr.open_dataset(eddy_data_path + "eddy_trajectory_nrt_3.0exp_cyclonic_20180101_20200712.nc").sel(NbSample=0).attrs
